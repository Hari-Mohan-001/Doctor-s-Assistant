...
import { Home, Link2, LogOut ,ChevronDown, SearchIcon } from "lucide-react";
        ...
        <div className="flex items-center gap-3">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger className="decoration-0 flex items-center">
                <div className=" flex bg-amber-50 w-10 h-10 border-red-400 border-1 rounded-full items-center justify-center">
