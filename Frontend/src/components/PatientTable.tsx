            ...
            <TableCell>
              <div className="flex flex-col">
                ...
                <span className="text-slate-500 text-xs">
                  {data.age}, <span>{data.gender}</span>
                </span>
              </div>
            </TableCell>
            <TableCell>
              <span className="text-xs text-slate-500">{data.condition}</span>
            </TableCell>
              ...
              <span
                className={`${
                  data.status === "open"
                    ...
                    : "text-green-600  bg-green-200 rounded-md px-3 py-0.5 flex items-center"
                }`}
              >
                {data.status}
              </span>
