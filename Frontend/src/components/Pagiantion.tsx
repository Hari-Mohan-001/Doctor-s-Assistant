  ...
  return (
    <div className="mt-40 flex justify-between items-center">
          ...
          <div className="flex items-center justify-center h-12">
            ...
            <span className="border-gray-500 bg-gray-300 rounded-md text-slate-500  shadow-lg"><ChevronLeft/></span>
            <span className=" text-slate-500 text-xs">1/1</span>
            <span className="border-gray-500 bg-gray-300 rounded-md text-slate-500  shadow-lg"><ChevronRight/></span>
          </div>
        </div>
  )
}
